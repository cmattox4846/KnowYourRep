...
const BarChartNominationsDisplayTable =(props)=>{
    return(
<div>        {props.senatorNomVoteList.map((senator) => {
        ...
        <div className=" Senatortable2">
            <h5>Nomination Details</h5>
              ...
              <thead>
                      <th>
                        <div><Link to="/Bills"  > {senator.nomination.number} ({senator.description})</Link></div>   <div>
...
export default BarChartNominationsDisplayTable